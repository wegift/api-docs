...
Filtering needs knowlege of the available categories. You can now fetch the full list of product categories supported by the API using the [List categories](/reference/2024-02-05/endpoint/products/categories) endpoint making it easier to build dynamic category selectors or validate category names.
