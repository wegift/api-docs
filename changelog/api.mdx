...
<Update label="July 2025" tags={["Feature", "Ordering"]}>

## New metadata field added to order response

We've added a new `metadata` field to the order response. You can use this field to attach additional, customer-specific data to the order. This is for your internal use, the information stored here will not be exposed to the end user.
