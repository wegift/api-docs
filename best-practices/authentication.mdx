...
<img className="block dark:hidden" src="/assets/graphics/api-key-light.png" alt="API key example showing the key wgABC123.abc12345678defghijklmnopqrst~XYZ" />
<img className="hidden dark:block" src="/assets/graphics/api-key-dark.png" alt="API key example showing the key wgABC123.abc12345678defghijklmnopqrst~XYZ" />
