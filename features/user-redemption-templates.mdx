---
title: Customizing and branding the redemption experience
...
| **Sender Name**        | Email               | A custom sender name can be used for email delivery.          |
| **Subject**            | Email               | A custom subject can be used for email delivery.              |
| **Message**            | Email               | A custom message can be used for email delivery.              |
| **Banner Image**       | Email               | A custom banner image can be used for email delivery.         |
| **Privacy Policy URL** | Email               | A custom privacy policy URL can be added to the email.        |
