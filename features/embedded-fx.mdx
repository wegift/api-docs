...
<Note>
By default, this feature applies standard FX fees in production. If you haven't negotiated custom rates, those standard fees will apply. To learn more or discuss custom pricing, [talk to an expert](https://runa.io/products/runa-fx) or contact your account manager
</Note>
