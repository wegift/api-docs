...
Two types of alerts are available. **Predictive balnce emails** automatically notify you when your balance is expected to become low based on your previous order volumes. **Custom balance thresholds** allow you to set a specific balance threshold and be notified when your balance falls below that threshold.
