...
Balances empower you to monitor available funds across [all supported currencies](/api-reference/countries) in your account. It's crucial to maintain adequate balances, as insufficient funds may lead to order failures. Regularly checking your balances can help prevent such issues and we recommend setting up an alert in your system so that the relevant teams can be notified.

Refer to our list of supported currencies for a comprehensive understanding of available options.

This guide serves as documentation for developers, providing instructions on utilizing the Runa API to [fetch balances](/api-reference/2024-02-05/endpoint/balance/get).
