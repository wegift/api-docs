...
description: "Retrieve gift card redemption details programmatically to present them within your own customer experience."
icon: "code"
---
...
<RequestExample>
  ```http GET https://spend.runa.io/-/abc123…def?format=json ```
</RequestExample>
