...
![](https://files.readme.io/713455c-image.png)

To restrict the available products in a Payout Link, you can define the desired products within the order items when making a request to the [Create Order](/api-reference/2024-02-05/endpoint/orders/create) endpoint. Here are some examples to assist you in creating your payload.
...
To choose the products you want to include in your order, you can explore Runa's product network using the [List Products](/api-reference/2024-02-05/endpoint/products/list) endpoint. Follow the steps below to utilize this endpoint effectively:

1. To get a list of all supported countries, you can use [supported countries](/api-reference/2024-02-05/endpoint/products/countries)
2. Make a request to the [List Products](/api-reference/2024-02-05/endpoint/products/list) endpoint. You can optionally filter by one or more countries from the list returned above.

To quickly test out the endpoint and view the product list, you can navigate to the API reference for the [List Products](/api-reference/2024-02-05/endpoint/products/list) endpoint.

![](https://files.readme.io/bfa24e2-Screenshot_2024-02-07_at_13.13.09.png)
