...
<Frame caption="The status code dropdown in the response section switches between the different response types.">
  <img
    ...
    src="/assets/screenshots/response-dropdown-light.png"
  />
  <img
    className="hidden dark:block"
    src="/assets/screenshots/response-dropdown-dark.png"
  />
</Frame>
...
The reference is generated from an OpenAPI 3.1 specification which you can download and use to generate clients or feed to AI tools. See the [OpenAPI specification page](/reference/2024-02-05/openapi) for the URL and guidance.

## Test endpoints in the browser

<img
  className="inline dark:hidden m-0 ml-4 mb-4 h-10"
  align="right"
  src="/assets/screenshots/try-it-light.png"
/>
<img
  className="hidden dark:inline m-0 ml-4 mb-4 h-10"
  align="right"
  src="/assets/screenshots/try-it-dark.png"
/>
