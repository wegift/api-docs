...
openapi: "/reference/2026-09-08/openapi.json GET /product/{product_code}"
---
...
This endpoint supports returning product content in different formats. See the [content](/reference/2026-09-08/endpoint/products/get#parameter-content) parameter for more details.
